    ...
    return (
      <DormStyle>
        ...
        <svg className="svg">
          ...
          <text className="text" x="120" y="556">101</text>
          <text className="text" x="221" y="556">102</text>
          <text className="text" x="320" y="556">103</text>
          <text className="text" x="416" y="556">104</text>
          <text className="text" x="505" y="556">105</text>
          <text className="text" x="596" y="556">106</text>
          <text className="text" x="692" y="556">107</text>
          <text className="text" x="779" y="556">108</text>
          <text className="text" x="859" y="556">109</text>
          <text className="text" x="937" y="556">110</text>
        </svg>
      </DormStyle>
    );
  }
