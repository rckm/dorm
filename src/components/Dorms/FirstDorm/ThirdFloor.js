    ...
    return (
      <DormStyle>
        ...
        <svg className="svg">
          ...
          <text className="text" x="120" y="556">301</text>
          <text className="text" x="221" y="556">302</text>
          <text className="text" x="320" y="556">303</text>
          <text className="text" x="416" y="556">304</text>
          <text className="text" x="505" y="556">305</text>
          <text className="text" x="596" y="556">306</text>
          <text className="text" x="692" y="556">307</text>
          <text className="text" x="779" y="556">308</text>
          <text className="text" x="859" y="556">309</text>
          <text className="text" x="937" y="556">310</text>
        </svg>
      </DormStyle>
    );
  }
